...
(function(){
  ...
  (function(){
    ...
    if (!socialcalcPath) {
      var nestedDist = path.join(FindBin, 'node_modules', 'socialcalc', 'dist', 'SocialCalc.js');
      var nested = path.join(FindBin, 'node_modules', 'socialcalc', 'SocialCalc.js');
      if (fs.existsSync(nestedDist)) socialcalcPath = nestedDist;
      else if (fs.existsSync(nested)) socialcalcPath = nested;
    }
    if (!socialcalcPath) {
      var topDist = path.join(FindBin, '..', 'socialcalc', 'dist', 'SocialCalc.js');
      var top = path.join(FindBin, '..', 'socialcalc', 'SocialCalc.js');
      if (fs.existsSync(topDist)) socialcalcPath = topDist;
      else if (fs.existsSync(top)) socialcalcPath = top;
    }
    bootSC = fs.readFileSync(socialcalcPath, 'utf8');
  })();
